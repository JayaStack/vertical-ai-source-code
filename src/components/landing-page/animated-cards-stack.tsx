// animated-cards-stack.tsx - Fixed version
"use client"
...
const CardsContainer = React.forwardRef<
    HTMLDivElement,
    React.HTMLAttributes<HTMLDivElement>
...
const CardTransformed = React.forwardRef<
    HTMLDivElement,
    CardStickyProps
>(
    (
...
const ReviewStars = React.forwardRef<HTMLDivElement, ReviewProps>(
