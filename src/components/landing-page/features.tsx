...
export default function FeaturesSection() {
  ...
  return (
    <div id="features" className="min-h-screen text-white py-12 sm:py-16 px-4 sm:px-6 overflow-x-hidden lg:overflow-x-visible">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="relative">
                ...
                <div className="block lg:hidden mt-6 border-t border-primary/40 w-full mx-auto" />
              </div>
            );
          })}
        </div>
      ...
      <motion.div
        className="max-w-screen-xl mx-auto border-t border-primary/40 mt-12 sm:mt-16"
        initial={{ opacity: 0 }}
