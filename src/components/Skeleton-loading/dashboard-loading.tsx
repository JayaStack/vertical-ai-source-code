    ...
    <div className="min-h-screen text-foreground p-4 sm:p-6">
        <div className="max-w-[1240px] mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="h-10 w-full sm:w-40 bg-primary/70 rounded animate-pulse" />
            </div>
            ...
            <div className="space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="h-8 w-full sm:w-32 bg-primary/70 rounded animate-pulse" />
                </div>
            ...
            {/* CTA Banner Skeleton */}
            <div className="bg-gradient-to-r from-primary/20 to-primary/20 rounded-2xl p-6 sm:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                ...
                <div className="h-12 w-full sm:w-48 bg-primary/70 rounded animate-pulse" />
            </div>
        </div>
    </div>
);
