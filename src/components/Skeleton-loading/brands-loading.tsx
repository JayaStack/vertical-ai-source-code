const BrandsLoadingSkeleton = () => (
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 max-w-7xl">
    ...
    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
      ...
      <div className="h-10 w-32 sm:w-40 bg-primary/70 rounded-md animate-pulse self-start sm:self-auto" />
    </div>
          ...
          <div className="space-y-6 px-4 pb-5">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[0, 1, 2].map((i) => (
                ...
                >
                  <div className="h-4 w-4 bg-primary/60 rounded-md animate-pulse mb-2" />
